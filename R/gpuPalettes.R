...
#'
#' @param names names of desired color palettes; if `NULL`, color palettes available are printed.
#' @param ncol An integer indicating the number of colors to be returned (involves a call to [grDevices::colorRampPalette()]). Default is set to ``NULL`` in which case the number in the one the palette is made of.
#'
