...
#'
#' @param fromcol starting color, i.e. `percentage = 0`, it is the
#' color returned.
#' @param tocol color to nuance `fromcol`, i.e. `percentage = 100`, it
#' is the color returned.
#' @param percentage percentage determining the percentage of `tocol` used to
#' nuance `fromcol`. Note that `darken` and `lighten` support negative
#' percentage.
