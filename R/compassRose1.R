...
#' @export
compassRose2 <- function(x = 0, y = 0, rot = 0, cex.cr = 1, cex.let = 1, offset = 1.2, 
    col = c(1, 8), border = c(1, 8), lty = 1) {
    compassRose1(x, y, rot + 22.5, cex.cr * 0.65, labels = rep("", 4), cex.let = cex.let, 
        offset = offset, col = col, border = border, lty = lty)
    compassRose1(x, y, rot + 67.5, cex.cr * 0.65, labels = rep("", 4), cex.let = cex.let, 
        offset = offset, col = col, border = border, lty = lty)
    compassRose1(x, y, rot + 45, cex.cr * 0.85, labels = c("SW", "NW", "NE", "SE"), 
