...
#' donut(c(10,20,15), 0.2, cx=4, col=4, mycol=c(4,3,2), density=30, angle=c(20,55,110), add=TRUE)
#'
#' #Example 2:
...
donut<-
function(vec, eaten=0, labels=NULL, rot=0, cex=0.8, tck=0.05, width=0.6, mycol=1+1:length(vec), density=NULL, angle=45, dt=0.001, add=FALSE, cx=0, cy=0, border=NA, clockwise=TRUE, ...){
