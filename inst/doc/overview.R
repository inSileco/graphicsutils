...
## ----plot00, fig.height=6, fig.width=6, fig.cap="plot0() and plotAreaColor()"----
...
## ----circles, fig.height=6, fig.width=6----------------------------------
par(mar=c(1,1,1,1), mfrow=c(2,2))
plot0()
circles(0, 0, 1)
plot0()
...
## ----plotMeans, fig.height=3, fig.width=6--------------------------------
...
## ----compassRose, fig.height=6, fig.width=6------------------------------
...
## ----envelop, fig.height=6, fig.width=6----------------------------------
plot0(c(0,10),c(0,10))
sz <- 100
...
## ----plotImage2, fig.height=6, fig.width=6-------------------------------
...
## ----pchImage2, fig.height=6, fig.width=6--------------------------------
img<-png::readPNG(system.file('img', 'Rlogo.png', package='png'), native=TRUE)
n<-15
plot0(c(0,1),c(0,1))
...
## ----darken, fig.height=6, fig.width=6-----------------------------------
someblue <- darken("blue", 10*1:9)
showPalette(someblue)

## ----lighten, fig.height=6, fig.width=6----------------------------------
somered <- lighten("red", 10*1:9)
showPalette(somered)

## ----showpal, fig.height=6, fig.width=6----------------------------------
...
## ----envelop2,  fig.width=6,  fig.height=6-------------------------------
plot0(c(0, 10),c(0, 10))
sz <- 100
seqx <- seq(0, 10, length.out=sz)
seqy1 <- 0.2*seqx*runif(sz, 0, 1)
...
## ----stackedArea,  fig.width=6,  fig.height=6----------------------------
...
## ----polarPlot,   fig.width=6,  fig.height=6-----------------------------
polarPlot(1:40, stats::runif(40), to=1.9*pi, col="grey30", border="grey80")

## ----vectorfields,  fig.height = 6, fig.width = 6------------------------
